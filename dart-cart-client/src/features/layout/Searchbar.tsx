...
import { fetchShopProducts, getSearchString, updatedSearchString } from "../../common/slices/shopProductSlice";
...
const Searchbar = () => {
    ...
    return (
        <div className="navbar-brand">
            <div className="form-inline my-2 my-lg-0" style={{ width: "100%" }}>
                <button
