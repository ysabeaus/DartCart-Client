...
export interface InputProps
    extends Omit<React.InputHTMLAttributes<HTMLInputElement>, "onBlur" | "onChange" | "onFocus" | "onKeyDown"> {
...
export interface TypeaheadProps<T extends TypeaheadModel> {
    ...
    renderMenuItemChildren?:
        | ((option: TypeaheadResult<T>, props: TypeaheadMenuProps<T>, index: number) => React.ReactNode)
        | undefined;
